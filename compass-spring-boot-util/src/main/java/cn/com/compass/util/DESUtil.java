...
public class DESUtil {
    ...
    public static void main(String[] args) {
    	try {
//    		System.out.println(RadomUtil.generateString(32));
			System.out.println(encrypt("VWz3csZkutm9bKfRwYcfAQsveTbv5FJ4", "root"));
			System.out.println(decode("VWz3csZkutm9bKfRwYcfAQsveTbv5FJ4", "uPPYRFLtqVc="));
		} catch (Exception e) {
			e.printStackTrace();
		}
    }
