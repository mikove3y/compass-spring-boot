 ...
 * @todo mybatis 枚举转换
 * @date 2018年6月7日 下午3:55:07
 *
 */
public class MybatisDbEnumTypeHandler<E extends IBaseBizStatusEnum> extends BaseTypeHandler<E> {
     ...
     */  
    public MybatisDbEnumTypeHandler(Class<E> type) {  
        if (type == null)  
