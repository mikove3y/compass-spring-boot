...
import cn.com.compass.web.annotation.BaseServiceLog;
...
public class BaseServiceLogAspect {
	 ...
	 * 定义日志切入点
	 */
	@Pointcut("@annotation(cn.com.compass.web.annotation.BaseServiceLog)")
	 ...
	 * @throws Throwable
	 */
//	@Around("@annotation(cn.com.compass.core.annotation.OperationLog)")
...
//	}
	 ...
	 * @throws Exception
	 */
	private static BaseServiceLog getMethodLogAnnotation(JoinPoint joinPoint) throws Exception {
		MethodSignature signature = (MethodSignature) joinPoint.getSignature();
		Method method = signature.getMethod();
		return  method.getAnnotation(BaseServiceLog.class);
	}
