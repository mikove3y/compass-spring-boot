...
public class LocalCamelProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		// modify by wanmk 2018-11-14 14:42 dataScop&power转移到redis缓存中
...
//		String power = (String) exchange.getIn().getHeader(BaseConstant.POWER_KEY);
		...
		// 放入线程localCamel缓存
		LocalCamel.getLocalCamel().init(subject, authorization,sysDeveloper);
		...
		headerCache.put(BaseConstant.SYSDEVELOPER_KEY, sysDeveloper);
//		headerCache.put(BaseConstant.REQUEST_DATA_PERMISSION, dataScop);
//		headerCache.put(BaseConstant.POWER_KEY, power);
